// Lightweight stroke-icon set (lucide-style geometry, inlined so the app
// stays dependency-free). Icons read as "built by a dev" in a way emoji
// glyphs never do — consistent weight, color inherits from text.
const PATHS = {
